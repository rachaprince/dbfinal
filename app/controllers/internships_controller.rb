...
#    @survey=Podio::Item.find_basic(339892745)
  ...
  private
    ...
    def internship_params
      params.require(:internship).permit(:type, :name, :start_date, :end_date, :key_learning, :overall_rating, :overall_expl, :internship_rating, :internship_expl, :participant_id)
    end
end
